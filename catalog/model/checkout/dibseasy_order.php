...
class ModelCheckoutDibseasyOrder extends ModelCheckoutOrder {
		...
		if ($order_info && !$order_info['order_status_id']) {
			...
			$language->load('mail/dibseasy_order');
			...
			foreach ($order_voucher_query->rows as $voucher) {
				$template->data['vouchers'][] = array(
					...
					'amount'      => $this->currency->format($voucher['amount'], $order_info['currency_code'], $order_info['currency_value']),
                        ...
                        $template->data['store_details'] = 'Store details';
                        
                 	$template->data['totals'] = $order_total_query->rows;

			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/mail/dibseasy_order.tpl')) {
				$html = $template->fetch($this->config->get('config_template') . '/template/mail/dibseasy_order.tpl');
			} else {
				$html = $template->fetch('default/template/mail/dibseasy_order.tpl');
			}
